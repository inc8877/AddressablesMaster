...
namespace AddressablesMaster
{
    internal static class Exceptions
    {
        ...
        private const string _noInstanceKeyInitialized =
            "No instance with key={0} has been instantiated through AddressablesManager.";

        private const string _noInstanceReferenceInitialized =
            "No instance with key={0} has been instantiated through AddressablesManager.";
        ...
        private const string _noSceneReferenceLoaded =
            "No scene with reference={0} has been loaded through AddressablesManager.";
        ...
        private const string _assetReferenceExist =
            "An asset of type={0} has been already registered with reference={1}.";
